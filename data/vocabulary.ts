...
const seedVocabulary: VocabSeed[] = [
  ...
  // ── B2–C1 (3): cause, process, discourse, institutions ────────────────────
  {
    french: "du fait de",
    pronunciation: "dy fɛ də",
    english: "because of; owing to (explanation)",
    partOfSpeech: "prepositional phrase",
    example: {
      french: "Du fait de la grève, plusieurs lignes de métro sont restées fermées ce matin.",
      english: "Because of the strike, several metro lines stayed closed this morning.",
    },
    explanation: "+ noun phrase. Formal written French, common in news and admin. Near-synonym of 'en raison de'; stronger causal tone than simple 'à cause de' in some registers.",
  },
  {
    french: "en vertu de",
    pronunciation: "ɑ̃ vɛʁ.ty də",
    english: "by virtue of; pursuant to (law, contract)",
    partOfSpeech: "prepositional phrase",
    example: {
      french: "En vertu du contrat, le fournisseur doit livrer au plus tard sous trente jours.",
      english: "Pursuant to the contract, the supplier must deliver within thirty days at the latest.",
    },
    explanation: "Legal and contractual basis for an obligation or power. More technical than 'selon'.",
  },
  {
    french: "moyennant",
    pronunciation: "mwajɛ.nɑ̃",
    english: "in exchange for; on payment of",
    partOfSpeech: "preposition",
    example: {
      french: "Moyennant le règlement des frais de dossier, votre demande sera instruite sous deux semaines.",
      english: "On payment of the application fees, your request will be processed within two weeks.",
    },
    explanation: "+ noun (often money). Administrative and legal. Old participle of 'moyenner'; fixed form in modern French.",
  },
  {
    french: "s'agissant de",
    pronunciation: "sa.ʒi.sɑ̃ də",
    english: "as regards; with respect to (formal letters)",
    partOfSpeech: "conjunctional phrase",
    example: {
      french: "S'agissant de votre courrier du 3 avril, nous vous confirmons la bonne réception des pièces.",
      english: "With respect to your letter of 3 April, we confirm safe receipt of the documents.",
    },
    explanation: "Opens a paragraph in official replies. Present participle of 's'agir'. Very standard in administration; stiff in casual chat.",
  },
  {
    french: "il s'agit de",
    pronunciation: "il sa.ʒi də",
    english: "it is a matter of; we are talking about",
    partOfSpeech: "impersonal phrase",
    example: {
      french: "Il s'agit ici de protéger les personnes les plus vulnérables, pas de faire des économies à tout prix.",
      english: "Here we are talking about protecting the most vulnerable people, not about saving money at any cost.",
    },
    explanation: "Impersonal: + noun or infinitive. 'De quoi s'agit-il ?' = what is this about? Ubiquitous in essays, speeches, and reports.",
  },
  {
    french: "en l'occurrence",
    pronunciation: "ɑ̃ lɔ.ky.ʁɑ̃s",
    english: "in this case; on this occasion",
    partOfSpeech: "adverbial phrase",
    example: {
      french: "En l'occurrence, le juge a appliqué la jurisprudence la plus récente sur la matière.",
      english: "In this case, the judge applied the most recent case law on the subject.",
    },
    explanation: "Picks out the specific instance under discussion. Spoken and written professional French. 'L'occurrence' = this particular occurrence.",
  },
  {
    french: "dans la foulée",
    pronunciation: "dɑ̃ la fu.le",
    english: "immediately afterwards; in the same go",
    partOfSpeech: "adverbial phrase",
    example: {
      french: "Il a annoncé sa démission et, dans la foulée, prévu un départ pour l'étranger.",
      english: "He announced his resignation and, right after, planned to leave for abroad.",
    },
    explanation: "One action follows another with no gap. Colloquial-professional middle ground. 'Foulée' = stride; image of not breaking step.",
  },
  {
    french: "à première vue",
    pronunciation: "a pʁə.mjɛʁ vy",
    english: "at first sight; on the face of it",
    partOfSpeech: "adverbial phrase",
    example: {
      french: "À première vue, l'offre semble équilibrée, mais les clauses de sortie méritent attention.",
      english: "On the face of it, the offer looks balanced, but the exit clauses deserve attention.",
    },
    explanation: "Provisional judgment before detail. Often corrected by 'mais' or 'cependant'. Compare 'à priori' (as things stand) — overlapping but not identical.",
  },
  {
    french: "tant bien que mal",
    pronunciation: "tɑ̃ bjɛ̃ kə mal",
    english: "with difficulty; after a struggle",
    partOfSpeech: "adverbial phrase",
    example: {
      french: "Tant bien que mal, les secours ont évacué tout le monde avant l'effondrement du toit.",
      english: "With difficulty, emergency services got everyone out before the roof collapsed.",
    },
    explanation: "Success is partial or hard-won. Fixed phrase; do not analyse as separate words. Emotional nuance of muddling through.",
  },
  {
    french: "d'ores et déjà",
    pronunciation: "dɔʁ e de.ʒa",
    english: "already; with immediate effect (formal)",
    partOfSpeech: "adverb",
    example: {
      french: "Certaines mesures sont d'ores et déjà applicables sur le territoire métropolitain.",
      english: "Certain measures are already applicable in metropolitan France with immediate effect.",
    },
    explanation: "Formal announcements: something applies from now, not only in the future. Literary 'ores' (now) + 'déjà'. Rare in casual speech.",
  },
  {
    french: "à l'instar de",
    pronunciation: "a lɛ̃s.taʁ də",
    english: "in the manner of; like (a model)",
    partOfSpeech: "prepositional phrase",
    example: {
      french: "À l'instar de plusieurs voisins européens, le pays renforce les contrôles aux frontières.",
      english: "Like several European neighbours, the country is tightening border checks.",
    },
    explanation: "+ noun: parallel or imitation. Journalistic and official. Slightly more bookish than 'comme'.",
  },
  {
    french: "en amont",
    pronunciation: "ɑ̃ na.mɔ̃",
    english: "upstream (earlier in the process)",
    partOfSpeech: "adverb / prepositional phrase",
    example: {
      french: "Il vaut mieux prévenir en amont plutôt que de gérer une crise une fois qu'elle a éclaté.",
      english: "It's better to act upstream in the process than to manage a crisis once it has broken out.",
    },
    explanation: "Project management, ecology, policy: before the problem reaches the user or downstream. Opposite: 'en aval'.",
  },
  {
    french: "en aval",
    pronunciation: "ɑ̃ na.val",
    english: "downstream (later in the process)",
    partOfSpeech: "adverb / prepositional phrase",
    example: {
      french: "Les communautés situées en aval du barrage ont été alertées en cas de lâchage d'eau.",
      english: "Communities located downstream from the dam were warned in case of water release.",
    },
    explanation: "Literal rivers; figurative chains of production or consequences. Pairs with 'en amont' in analysis.",
  },
  {
    ...
    example: {
      french: "Toute décision judiciaire doit tenir compte de l'intérêt supérieur de l'enfant.",
      english: "Any court decision must take the best interests of the child into account.",
    },
    explanation: "'Compte' is masculine here. Common in law, ethics, design. Negative: 'sans tenir compte de' = ignoring.",
  },
  {
    french: "faire valoir",
    pronunciation: "fɛʁ va.lwaʁ",
    english: "to put forward; to assert (rights, arguments)",
    partOfSpeech: "verb phrase",
    example: {
      french: "Les organisations syndicales font valoir des revendications salariales depuis des mois.",
      english: "Trade unions have been putting forward pay demands for months.",
    },
    explanation: "Also legal: 'faire valoir ses droits'. Do not confuse with 'se faire remarquer' (to draw attention to oneself). Irregular valoir family.",
  },
  {
    french: "porter atteinte à",
    pronunciation: "pɔʁ.te a.tɛ̃t a",
    english: "to infringe on; to harm (rights, reputation)",
    partOfSpeech: "verb phrase",
    example: {
      french: "La mesure ne doit porter atteinte ni aux libertés publiques ni au secret des correspondances.",
      english: "The measure must not infringe either civil liberties or the privacy of correspondence.",
    },
    explanation: "Legal and human-rights register. Noun: 'une atteinte à'. Stronger than simple 'nuire à' in formal texts.",
  },
  {
    french: "en termes de",
    pronunciation: "ɑ̃ tɛʁm də",
    english: "in terms of (framing a topic)",
    partOfSpeech: "prepositional phrase",
    example: {
      french: "En termes de coût total, la solution B reste nettement plus avantageuse sur cinq ans.",
      english: "In terms of total cost, option B remains clearly more advantageous over five years.",
    },
    explanation: "Very frequent in business and academia. Anglicism calque fully naturalised. Some purists prefer 'sur le plan de', but 'en termes de' dominates speech.",
  },
  {
    french: "recourir à",
    pronunciation: "ʁə.ku.ʁiʁ a",
    english: "to have recourse to; to turn to",
    partOfSpeech: "verb",
    example: {
      french: "Face à l'impasse négociée, les parties ont dû recourir à un médiateur extérieur.",
      english: "Facing a deadlock in negotiations, the parties had to turn to an outside mediator.",
    },
    explanation: "Formal: use a means, person, or procedure when needed. Noun: 'un recours'. Not 'recourir de'.",
  },
  {
    french: "invoquer",
    pronunciation: "ɛ̃.vɔ.ke",
    english: "to invoke (a law, reason, right)",
    partOfSpeech: "verb",
    example: {
      french: "La défense invoque la présomption d'innocence et demande la relaxe.",
      english: "The defence invokes the presumption of innocence and asks for acquittal.",
    },
    explanation: "Law, debate, rhetoric: call on a principle as authority. Different from English 'invoke' a spirit — rare that sense in French news French.",
  },
  {
    french: "alléguer",
    pronunciation: "a.le.ʒe",
    english: "to allege (without proof yet)",
    partOfSpeech: "verb",
    example: {
      french: "Le plaignant allègue avoir subi des pressions avant de signer le document.",
      english: "The complainant alleges that he was put under pressure before signing the document.",
    },
    explanation: "Legal and journalistic: claim that may be disputed. Spelling: 'il allègue'. Not 'alléger' (to lighten) — false friend in listening.",
  },
  {
    french: "occulter",
    pronunciation: "ɔ.kyl.te",
    english: "to conceal; to leave in the dark (deliberately)",
    partOfSpeech: "verb",
    example: {
      french: "Le rapport occulte plusieurs aspects sensibles du dossier sans les mentionner clairement.",
      english: "The report conceals several sensitive aspects of the case without clearly mentioning them.",
    },
    explanation: "Figurative: hide from view. Stronger than 'omettre' (omit) when intent is suspected. Same root as 'occult' but everyday in media criticism.",
  },
  {
    french: "minimiser",
    pronunciation: "mi.ni.mi.ze",
    english: "to downplay; to minimize",
    partOfSpeech: "verb",
    example: {
      french: "Ne minimise pas l'importance de ce signal d'alarme : il mérite une enquête sérieuse.",
      english: "Don't downplay the importance of this warning — it deserves a serious investigation.",
    },
    explanation: "Psychology, politics, PR. Noun: 'une minimisation'. Loanword fully integrated; pronounce French-style.",
  },
  {
    french: "stigmatiser",
    pronunciation: "stig.ma.ti.ze",
    english: "to stigmatize; to brand (negatively)",
    partOfSpeech: "verb",
    example: {
      french: "Stigmatiser les chômeurs ne résout en rien les problèmes structurels du marché du travail.",
      english: "Stigmatising the unemployed does nothing to solve the labour market's structural problems.",
    },
    explanation: "Social debate vocabulary. Assign shame to a group. Noun: 'une stigmatisation'.",
  },
  {
    french: "légitimer",
    pronunciation: "le.ʒi.ti.me",
    english: "to legitimize; to make acceptable",
    partOfSpeech: "verb",
    example: {
      french: "Le référendum visait à légitimer politiquement la réforme contestée.",
      english: "The referendum aimed to give political legitimacy to the contested reform.",
    },
    explanation: "Sociology and politics: make something appear rightful. Adjective 'légitime' = legitimate. Pair concept: 'délégitimer'.",
  },
  {
    french: "délégitimer",
    pronunciation: "de.le.ʒi.ti.me",
    english: "to delegitimize; to undermine legitimacy",
    partOfSpeech: "verb",
    example: {
      french: "Le scandale a fini par délégitimer l'ensemble de la direction auprès du personnel.",
      english: "The scandal ended up delegitimising the entire leadership in the eyes of the staff.",
    },
    explanation: "Modern political coinage, common in analysis of institutions. Regular -er verb despite length.",
  },
  {
    french: "se prévaloir de",
    pronunciation: "sə pʁe va.lwaʁ də",
    english: "to claim the benefit of; to invoke (a status)",
    partOfSpeech: "verb (reflexive)",
    example: {
      french: "Vous ne pouvez pas vous prévaloir d'une erreur matérielle pour éviter vos obligations contractuelles.",
      english: "You cannot invoke a clerical error to avoid your contractual obligations.",
    },
    explanation: "Legal and argumentative: assert a right or advantage. Formal register; everyday speech might use 'profiter de' in softer contexts.",
  },
  {
    french: "éluder",
    pronunciation: "e.ly.de",
    english: "to evade (a question, issue)",
    partOfSpeech: "verb",
    example: {
      french: "Le ministre a éludé la question des suppressions d'emplois lors du point presse.",
      english: "The minister evaded the question of job cuts during the press briefing.",
    },
    explanation: "Journalism: avoid answering squarely. Near 'esquiver'. Noun: 'une élusion'.",
  },
  {
    french: "conjecturer",
    pronunciation: "kɔ̃.ʒɛk.ty.ʁe",
    english: "to conjecture; to guess from scraps",
    partOfSpeech: "verb",
    example: {
      french: "Sans données fiables, on ne peut que conjecturer sur les véritables raisons du retrait.",
      english: "Without reliable data, we can only conjecture about the real reasons for the withdrawal.",
    },
    explanation: "Explicit uncertainty. More formal than 'deviner'. Noun: 'une conjecture'.",
  },
  {
    french: "plaidoyer",
    pronunciation: "plɛ.dwaje",
    english: "plea; speech in defence (of a cause)",
    partOfSpeech: "noun (m)",
    example: {
      french: "Son plaidoyer en faveur du dialogue social a été applaudi par l'assistance.",
      english: "His plea in favour of social dialogue was applauded by the audience.",
    },
    explanation: "Law: counsel's speech. Figurative: any impassioned defence of a cause. Verb family: 'plaider'.",
  },
  {
    french: "préjudice",
    pronunciation: "pʁe.ʒydis",
    english: "harm; damage (especially legal)",
    partOfSpeech: "noun (m)",
    example: {
      french: "Le tribunal a estimé le préjudice moral et ordonné une indemnisation.",
      english: "The court assessed non-material harm and ordered compensation.",
    },
    explanation: "'À préjudice de' = to the detriment of. English 'prejudice' (bias) is often 'préjugé' — different word in French for that sense.",
  },
  {
    french: "synthèse",
    pronunciation: "sɛ̃.tɛz",
    english: "summary; synthesis (bringing strands together)",
    partOfSpeech: "noun (f)",
    example: {
      french: "Merci d'envoyer une synthèse d'une page la veille de la réunion stratégique.",
      english: "Please send a one-page summary the day before the strategy meeting.",
    },
    explanation: "Work and school: condensed overview. Verb: 'synthétiser'. Chemistry sense also exists — context disambiguates.",
  },
  {
    french: "paradigme",
    pronunciation: "pa.ʁa.digm",
    english: "paradigm (dominant model, framework)",
    partOfSpeech: "noun (m)",
    example: {
      french: "Le paradigme énergétique dominant doit évoluer si l'on veut tenir les objectifs climatiques.",
      english: "The dominant energy paradigm has to change if we want to meet climate targets.",
    },
    explanation: "Science, policy, business: shared set of assumptions. Kuhn-style usage common in French media. Masculine.",
  },
];
